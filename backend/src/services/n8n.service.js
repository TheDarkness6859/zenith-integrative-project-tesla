...
/**
 * Sends user data to an n8n webhook.
 * If it fails, it only logs the error and never blocks the main flow.
 */
const notifyN8n = async (path, payload) => {

    // Log the webhook endpoint and payload for debugging
    console.log(`[n8n] Calling: ${process.env.N8N_WEBHOOK_BASE}/${path}`);
...
// Notify n8n when a user registers
